...
> ⚠️ Make sure Proteus or your hardware simulation is running to emulate the connected devices before starting the Python server.
...
- Include tests & ensure existing tests pass

---

## ⚖️ License

**Unlicensed** – contact au
